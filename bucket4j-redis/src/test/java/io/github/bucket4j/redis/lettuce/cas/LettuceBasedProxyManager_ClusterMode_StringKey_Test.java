...
public class LettuceBasedProxyManager_ClusterMode_StringKey_Test extends AbstractDistributedBucketTest<String> {
    ...
    protected ProxyManager<String> getProxyManager() {
        return LettuceBasedProxyManager.builderFor(redisClient, StringCodec.UTF8)
