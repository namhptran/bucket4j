...
@Testcontainers
class ReactivePostgreSQLSelectForUpdateBasedProxyManagerTest extends AbstractDistributedReactiveBucketTest<Long> {
    @Container
    ...
    protected ReactiveProxyManager<Long> getReactiveProxyManager() {
        ...
        return new ReactivePostgreSQLSelectForUpdateBasedProxyManager<>(configuration);
    }
